      ...
      <div v-else-if="activeTab === 'about'" class="space-y-6">
        ...
        <div class="rounded-xl border border-border bg-card p-6">
          <div class="flex items-center gap-4">
            ...
            <div class="flex-1">
              <h3 class="text-lg font-semibold">{{ t('settings.about.appName') }}</h3>
              <p class="text-sm text-muted-foreground">{{ t('settings.about.appDescription') }}</p>
            </div>
            <div class="flex items-center gap-2">
              <span class="text-xs text-muted-foreground">{{ t('settings.about.version') }}</span>
              <span class="rounded-full bg-muted px-2.5 py-0.5 text-xs font-medium">v0.1.0</span>
            </div>
          </div>
          ...
          <div class="mt-6 flex flex-wrap gap-3">
            <a
              ...
              class="inline-flex items-center gap-2 rounded-lg border border-border px-4 py-2 text-sm font-medium transition-colors hover:bg-muted/50"
            >
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
